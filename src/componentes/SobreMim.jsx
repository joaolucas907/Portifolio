    ...
    lg:w-1/2'>
      <div className='sm:flex lg:block w-full'>
        <div className='sm:w-3/4 lg:w-full'>
          ...
          pela área de tecnologia e hoje em dia sou apaixonado por ela, tendo um nivel de aprendizado 
          relativamente rapido. As linguagens que eu mais domínio são <b>PHP</b> e <b>JavaScript</b>, tenho 
          domínio também em tecnologias como <b>Banco de dados relacional e não relacional</b> 
          e em <b>Linux CentOs e Debian</b>
          </div>
        </div>
